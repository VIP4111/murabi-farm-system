...
DEFAULT_ROLES = {
    ...
    # بند إضافي — طلب صريح: "عامله منزليه بدون مميزات او ربط فقط تظيفها
    # في ارواتب" — صفر صلاحيات عمداً (نفس نمط الأدوار فوق)، الهدف
    # الوحيد ظهورها كخيار مسمّى وظيفي بشاشة الرواتب لتسجيل راتبها.
    "housemaid": {
        "display_name": "عاملة منزلية",
        "is_system": False,
        "permissions": [],
    },
    "nurse": {
