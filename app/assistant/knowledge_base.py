...
ENTRIES: list[KBEntry] = [
    ...
    KBEntry(
        ...
        body=(
            ...
            "**هل النظام يقترح تطعيمات؟** لأ — ما فيه جدول تحصين معياري جاهز يقترحه تلقائياً حسب عمر/نوع الحيوان. النظام "
            "بس **يذكّرك** بموعد التحصين *القادم* بعد ما تسجّل تحصيناً فعلياً وتحدد له `next_due_date` بنفسك — أول تحصين "
            "لأي رأس قرارك أنت والطبيب بالكامل.\n"
