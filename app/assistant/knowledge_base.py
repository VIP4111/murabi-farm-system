...
ENTRIES: list[KBEntry] = [
    ...
    KBEntry(
        ...
        body=(
            "من القائمة الجانبية افتح 'الإجراء الجماعي' (شاشة مستقلة عن 'الحيوانات' العادية) — أشّر الرؤوس بعلامة ✓ (أو فلترة حسب حظيرة/فصيلة ثم تحديد الكل)، بعدها اختر العملية من القائمة (وزن، تحصين، ملاحظة، نقل حظيرة، بيع، نفوق، مرض، خطة علاج، عزل، سونار، أو 'استقبال دفعة جديدة' لتسجيل رؤوس جديدة) — تُطبَّق على كل الرؤوس المحددة دفعة وحدة.\n"
