...
ENTRIES: list[KBEntry] = [
    ...
    KBEntry(
        ...
        title="وش هو 'الإدخال الذكي'، وكيف أسجّل حدث بالنص أو الصوت؟",
        keywords=["الادخال الذكي", "تسجيل بالصوت", "مسودة اعتماد", "سجلت ولادة", "smart entry"],
        body=(
            "شاشة 'الإدخال الذكي' (رابط 🎙️ فوق شاشة المساعد الذكي) تخليك تكتب أو تسجّل صوتياً حدثاً صار فعلاً بالمزرعة، بصيغة عامية طبيعية — مثلاً 'سجلت ولادة اليوم لشاة رقم 405' أو 'سجلت وزن اليوم للرأس 900: 35 كيلو'.\n"
            "**قاعدة صارمة**: أنا أقترح مسودة بس — ما ينفَّذ أي شي فعلي بقاعدة البيانات إلا بعد ما تراجع البطاقة وتضغط 'اعتماد' بنفسك. المسودات المعلَّقة بدون قرار لمدة 48 ساعة تُحذف تلقائياً. الإجراءات المدعومة حالياً: تسجيل ولادة وتسجيل وزن بس — أي شي يخص جرعة دواء أو حذف سجل يُرفض تلقائياً ولا يوصلك أصلاً كمسودة."
        ),
    ),
    KBEntry(
