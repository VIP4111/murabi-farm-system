...
ENTRIES: list[KBEntry] = [
    ...
    KBEntry(
        ...
        title="كيف أسمّن مجموعة حيوانات؟",
        keywords=["اسمن مجموعة", "تسمين مجموعة", "تسمين دفعة", "غرض تسمين جماعي"],
        body=(
            "من 'الإجراء الجماعي' أشّر الرؤوس اللي تبي تسمّنها (فلترة بحظيرة تسهّلها لو كلها بحظيرة وحدة)، بعدها اختر 'تحديد الغرض جماعياً' من قائمة الإجراءات واختر 'تسمين' — يتحدد لكل الرؤوس المحددة دفعة وحدة.\n"
            "بعدها تلقاهم بتبويب 'التسمين' بشاشة 'الحيوانات' (فلتر عرض بس، مو مكان تضيف فيه — الإضافة تصير بتحديد الغرض زي فوق). الغرض 'تسمين' هو نفسه اللي يحدد هدف التغذية (بروتين/طاقة أعلى) لحساب خلطة العلف التلقائي لو حظيرتهم عندها مواعيد وجبات مجدولة."
        ),
    ),
    KBEntry(
    ...
    KBEntry(
        ...
        keywords=["جدول وجبات علف", "مواعيد وجبات", "توزيع علف تلقائي", "كم مره اعلف", "وجبة علف"],
        body=(
