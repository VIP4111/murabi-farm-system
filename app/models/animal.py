...
class Animal(db.Model):
    ...
    # حراً، عشان يصير أساساً موثوقاً لقواعد آلية خاصة بسلالة معيّنة (حظر
    # النحاس لسلالة النعيمي تحديداً — قوالب الأملاح العامة تحتوي نحاساً
    # بمستوى آمن لمعظم السلالات لكنه ساماً للنعيمي تحديداً).
